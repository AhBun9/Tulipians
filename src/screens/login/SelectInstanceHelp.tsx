        ...
        <View style={{paddingTop: borderPadding}}>
          ...
          <View style={[styles.headerView, {paddingBottom: theme.spacing * 8}]}>
            ...
            <Text
              ...
              {'Having trouble accessing our system?'}
            </Text>
          </View>
          ...
          <View style={{paddingHorizontal: borderPadding}}>
            <View style={[styles.row, {paddingBottom: theme.spacing * 5}]}>
              <View style={styles.textView}>
                <Text>
                  {'Enter our TulipHRM System URL to access your mobile login,'}
                </Text>
              </View>
            </View>
            <View style={[styles.row, {paddingBottom: theme.spacing * 5}]}>
              <View style={styles.textView}>
                <Text>
                  {
                    'Contact your system administrator or click on "Learn More" if you are not sure of your TulipHRM URL'
                  }
                </Text>
              </View>
            </View>
